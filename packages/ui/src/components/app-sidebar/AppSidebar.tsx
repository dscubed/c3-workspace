...
export function AppSidebar({
  ...
  const sites = buildSites(currentApp, isOrg, isClubAdmin);

  const handleLogout = async () => {
    const { createClient } = await import("@c3/supabase/client");
  ...
  return (
    <>
      ...
      >
        <Link href="/dashboard" className="flex items-center p-1">
